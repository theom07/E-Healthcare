...
<body>
    ...
    $hospitalQuery = $database->query("SELECT * FROM hospital WHERE email = '{$_SESSION["user"]}'");
    if ($hospitalQuery->num_rows == 1) {
        $hospitalData = $hospitalQuery->fetch_assoc();
        $hospitalName = $hospitalData['name'];
        $hospitalEmail = $hospitalData['email'];
    } else {
        // Handle the case where hospital details are not found
        $hospitalName = "Hospital Name Not Found";
        $hospitalEmail = "Email Not Found";
    }
                    ...
                    <td style="padding:10px" colspan="2">
                        <table border="0" class="profile-container">
                            <tr>
                                ...
                                <p class="profile-title"><?php echo $hospitalName; ?></p>
                                    <p class="profile-subtitle"><?php echo $hospitalEmail; ?></p>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
...
?>
                ...
                <?php
                    if($_POST){
                        ...
                        $sqlmain= "SELECT * FROM doctor WHERE hospital_name = '$hospitalName' ORDER BY docid DESC";
                    }
                ?>
                <tr>
                   <td colspan="5">
                       <center>
                        ...
                        <tr>
                                ...
                                <th class="table-headin">Hospital Name</th>
                        ...
                        <tbody>
                            <?php                                
                                ...
                                for ( $x=0; $x<$result->num_rows;$x++){
                                    ...
                                    $docid=$row["docid"];
                                    // $name_query = $database->query("SELECT docname FROM doctor WHERE hospital_name = '$hospitalName'");
...
if ($name_query) {
    ...
    if ($name_row) {
        ...
        echo '<tr>
           ...
           &nbsp;&nbsp;&nbsp;
           <a href="?action=drop&id='.$docid.'&name='.$docname.'" class="non-style-link"><button  class="btn-primary-soft btn button-icon btn-delete"  style="padding-left: 40px;padding-top: 12px;padding-bottom: 12px;margin-top: 10px;"><font class="tn-in-text">Remove</font></button></a>
            </div>
            </td>
        </tr>';
    } else {
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="spec" class="form-label">Hospital Name: </label>
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        echo     '       </select><br>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="cpassword" class="form-label">Hospital Name : </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                                <input type="text" name="hname" class="input-text" placeholder="Hospital Name" value='; echo $hospitalName; echo ' required><br>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
